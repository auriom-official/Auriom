...
const newsItems = [
  ...
  { date:'Apr 12, 2026', tag:'Award', title:'AURIOM wins "Best Audio Brand of the Year" at Tech India Awards 2026', body:'Competing against international heavyweights, AURIOM was recognized for its exceptional product quality, customer satisfaction scores, and disruptive pricing model.', img:'https://images.unsplash.com/photo-1614680376573-df3480f0c6ff?w=600&q=80' },
  ...
  { date:'Feb 14, 2026', tag:'Milestone', title:'AURIOM crosses 5 Million Happy Customers — A Thank You from our Founders', body:'Five million. A number that means the world to us. We thank each and every customer who believed in us, and we promise to keep earning that trust every single day.', img:'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=600&q=80' },
];
